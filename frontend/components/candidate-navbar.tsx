        ...
        <div className="flex h-16 items-center justify-between">
          <div className="flex items-center">
            ...
            <nav className="hidden md:flex ml-10 space-x-6">
              ...
              <Link href="/candidate/jobs" className="text-foreground/80 hover:text-foreground transition-colors">
                Find Jobs
              </Link>
              <Link href="/candidate/profile" className="text-foreground/80 hover:text-foreground transition-colors">
                My Profile
              </Link>
              <Link href="/candidate/messages" className="text-foreground/80 hover:text-foreground transition-colors">
                Messages
              </Link>
            </nav>
          </div>
