      ...
      <main className="container mx-auto px-4 py-8">
        ...
        >
          ...
          <div className="mt-4 md:mt-0">
            <Button className="gap-2" onClick={() => (window.location.href = "/candidate/cv-upload")}>
                    ...
                    <CardContent className="p-0">
                      <div className="p-6">
                        <div className="flex justify-between items-start mb-2">
                          <div>
                            <h3 className="font-semibold text-lg">TechCorp Inc.</h3>
                            <p className="text-muted-foreground text-sm">Technology • Remote</p>
                          </div>
                        ...
                        <p className="text-sm mb-4">
                          Looking for frontend developers with React expertise. Values strong communication and
                        ...
                        <div className="flex justify-between items-center">
                          <span className="text-sm text-muted-foreground">5 open positions</span>
                  ...
                  <CardContent className="p-6">
                    <div className="flex justify-between items-start">
                      <div>
                        ...
                        <p className="text-muted-foreground text-sm">Design Agency • San Francisco, CA</p>
                      </div>
