            ...
            <TabsContent value="upload">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Upload your CV in PDF, DOCX, or RTF format. Maximum file size: 5MB.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div 
                  ...
                  >
                    ...
                    {uploadState === "error" && (
                      <div className="space-y-4">
                        ...
                        <p className="text-muted-foreground mb-4">There was an error uploading your CV. Please try again.</p>
                ...
                <CardContent>
                  <div className="text-center py-12">
                    ...
                    <p className="text-muted-foreground mb-6 max-w-md mx-auto">
                      ...
                      skills, and education from your LinkedIn profile
                    </p>
